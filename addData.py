...
tables = {
    ...
    "ADMIN": "SELECT * FROM dbo.ADMIN",
    "EMPLOYEE": "SELECT * FROM dbo.EMPLOYEE",
    "CUSTOMER": "SELECT * FROM dbo.CUSTOMER",
    "PRODUCT": "SELECT * FROM dbo.PRODUCT",
    "PRODUCT_INFO": "SELECT * FROM dbo.PRODUCT_INFO",
    "ORDER": "SELECT * FROM dbo.[ORDER]",  # Bảng ORDER
    "ORDER_ITEM": "SELECT * FROM dbo.ORDER_ITEM",
    "INVENTORY": "SELECT * FROM dbo.INVENTORY",
    "SUPPLIER": "SELECT * FROM dbo.SUPPLIER"
}
